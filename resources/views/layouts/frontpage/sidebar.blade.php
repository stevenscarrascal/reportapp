        ...
        <ul class="list-unstyled menu-categories mt-2 " id="accordionExample">
            ...
            <li class="menu {{ (Route::currentRouteName() == 'coordinador.index' || Route::currentRouteName() == 'coordinador.show') ? 'active' : '' }}">
                <a href="{{route('coordinador.index')}}" aria-expanded="true" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" id="Home-3--Streamline-Core" height="14" width="14"><desc>Home 3 Streamline Icon: https://streamlinehq.com</desc><g id="home-3--home-house-roof-shelter"><path id="Subtract" fill="#000000" fill-rule="evenodd" d="M0.318182 6.0449C0.115244 6.23405 0 6.499 0 6.77642V12.5c0 0.8284 0.671573 1.5 1.5 1.5H6v-3c0 -0.5523 0.44772 -1 1 -1s1 0.4477 1 1v3h4.5c0.8284 0 1.5 -0.6716 1.5 -1.5V6.77642c0 -0.27742 -0.1152 -0.54237 -0.3182 -0.73152L7.3254 0.120372c-0.18725 -0.1604958 -0.46355 -0.160496 -0.6508 0L0.318182 6.0449Z" clip-rule="evenodd" stroke-width="1"></path></g></svg>
                        <span>Reportes</span>
                    </div>
                </a>
            </li>
